...
She went on trying lightening network and the experience was not good as most of the time the payment didn't went through because of unavaibility of liquidity and also she discovered that as the network works on liquidity providers to flow payments it has become centralized.
