...
Team Satoshi do not own anything, and We have provided initial idea and did deep feasibility analysis and we are giving it to the community to implement. Team Satoshi will not be doing any implementation and rather be involved in project management and custodial service if elected for by the community. 
